  ...
  return (
    <div>
      <Button
        ...
        sx={{
          backgroundColor: "rgb(244 157 12 / 0.3)",
          color: "#BC560A",
          "&:hover": {
            backgroundColor: "rgb(216 118 7 / 0.3)", // Optional hover effect
          },
          padding: "0.25rem 0.5rem", // Reduce the padding
          fontSize: "0.75rem", // Adjust the font size
          lineHeight: 1.2, // Change line height
          minWidth: "auto", // Optional: Remove default minimum width
          margin: "4px 0",
        }}
      >
        Select files
