...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="text-sm text-gray-600 mb-4">Last updated: December 09, 2024</p>
      <p className="mb-4">
      ...
      <ul className="list-disc list-inside mb-4 space-y-2">
        ...
        <li>
          ...
          &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Mugi.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Mugi, accessible from{" "}
          <a
            href="https://mugi.pet"
      ...
      <ul className="list-disc list-inside mb-4 space-y-2">
        <li>
          ...
          being sent. However, if You do not accept Cookies, You may not be able to use some parts of
          our Service. Unless you have adjusted Your browser setting so that it will refuse Cookies,
      ...
      <ul className="list-disc list-inside mb-4 space-y-2">
        <li>
          ...
          <a
            href="https://mugi.pet/contact"
            rel="external nofollow noopener noreferrer"
            target="_blank"
            className="text-blue-600 underline"
          >
            https://mugi.pet/contact
          </a>
        </li>
      </ul>
    </div>
